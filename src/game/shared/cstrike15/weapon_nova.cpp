...
class [[= ks::reflect::NetTable{ .name = "DT_WeaponNOVA" } ]]
      CWeaponNOVA : public CWeaponCSBase
{
public:
...
IMPLEMENT_REFLECT_TABLE( CWeaponNOVA, DT_WeaponNOVA );

#if defined( CLIENT_DLL )
#ifdef CLIENT_DLL
IMPLEMENT_REFLECT_PREDMAP( CWeaponNOVA );
#endif
#endif
