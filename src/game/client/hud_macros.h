...
#define HOOK_MESSAGE(x) \
	m_UMCMsg##x.Bind< ks::net::CS_UM_##x, ks::net::CCSUsrMsg_##x >( UtlMakeDelegate( __MsgFunc_##x ) )


#define HOOK_HUD_MESSAGE(y, x) \
	m_UMCMsg##x.Bind< ks::net::CS_UM_##x, ks::net::CCSUsrMsg_##x >( UtlMakeDelegate( __MsgFunc_##y##_##x ) )

#define HOOK_HUD_MESSAGE_REALTIME_PASSTHROUGH(y, x) \
	m_UMCMsg##x.BindRealtimePassthrough< ks::net::CS_UM_##x, ks::net::CCSUsrMsg_##x >( UtlMakeDelegate( __MsgFunc_##y##_##x ) )


// Message declaration for non-CHudElement classes
#define DECLARE_MESSAGE(y, x) bool __MsgFunc_##y##_##x(const ks::net::CCSUsrMsg_##x &msg) \
	{							\
		return y.MsgFunc_##x( msg );	\
	}

// Message declaration for CHudElement classes that use the hud element factory for creation
#define DECLARE_HUD_MESSAGE(y, x) bool __MsgFunc_##y##_##x(const ks::net::CCSUsrMsg_##x &msg) \
	{																\
