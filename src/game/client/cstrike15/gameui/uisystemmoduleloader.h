...
#ifndef UISYSTEMMODULELOADER_H
#define UISYSTEMMODULELOADER_H
#ifdef _WIN32
#pragma once
#endif

#include "utlvector.h"
#include "IUIModuleLoader.h"
...
// Purpose: Handles loading/unloading of different vgui modules into a shared context
//-----------------------------------------------------------------------------
class CUISystemModuleLoader : public IUIModuleLoader
{
public:
	CUISystemModuleLoader();
	~CUISystemModuleLoader();
...
extern CUISystemModuleLoader g_VModuleLoader;

#endif // UISYSTEMMODULELOADER_H
