...
IMPLEMENT_REFLECT_DATAMAP_SIMPLE( physfollower_t )

IMPLEMENT_REFLECT_DATAMAP_SIMPLE( CBoneFollowerManager )
...
IMPLEMENT_REFLECT_SERVERCLASS( CBoneFollower, DT_BoneFollower )
