...
public:
	...
	virtual void			ImpactTrace( trace_t *pTrace, int iDamageType, const char *pCustomImpactName = nullptr );
...
#define SetThink( a ) CBaseEntity::ThinkSet( static_cast <void (CBaseEntity::*)(void)> (a), 0, nullptr )
