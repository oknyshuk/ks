...
// Renamed from Assert to RmlAssert to avoid conflict with Source Engine's Assert macro
...
// Define the RmlUi assertion macros.
	...
	#define RMLUI_ASSERT(x)                                                   \
		if (!(x))                                                             \
		{                                                                     \
			if (!(::Rml::RmlAssert("RMLUI_ASSERT(" #x ")", __FILE__, __LINE__))) \
			{                                                                 \
				RMLUI_BREAK;                                                  \
			}                                                                 \
		}
	#define RMLUI_ASSERTMSG(x, m)                        \
		if (!(x))                                        \
		{                                                \
			if (!(::Rml::RmlAssert(m, __FILE__, __LINE__))) \
			{                                            \
				RMLUI_BREAK;                             \
			}                                            \
		}
	#define RMLUI_ERROR                                          \
		if (!(::Rml::RmlAssert("RMLUI_ERROR", __FILE__, __LINE__))) \
		{                                                        \
			RMLUI_BREAK;                                         \
		}
	#define RMLUI_ERRORMSG(m)                        \
